...
const mapAssetFromDB = (dbAsset: any): Asset => ({
    ...
    // Defaults for missing fields in IT table avoids TS errors
...
const ITEquipment: React.FC = () => {
    ...
    const fetchAssets = async () => {
        ...
        try {
            ...
            const { data: allocationsData, error: allocationsError } = await supabase
                ...
                .select('*, projects(name)') // Select project name through join
                .lte('start_date', today)
                .gte('end_date', today)
                .eq('status', 'Activo'); // Assuming 'Activo' status is used, or rely on dates

            if (allocationsError) {
                console.error('Error fetching allocations:', allocationsError);
                // Don't block asset loading if allocations fail
            }
            ...
            if (assetsData) {
                const mappedAssets = assetsData.map(dbAsset => {
                    ...
                    if (allocation) {
                        return {
                            ...baseAsset,
                            location: allocation.projects?.name || baseAsset.location, // Use joined project name
                            // responsible: allocation.responsible || baseAsset.responsible // If allocation has responsible
                        };
                    }
                    return baseAsset;
                });
    ...
    const filteredAssets = assets.filter(a => {
        // Ensure strictly Equipos de Informática
        ...
        try {
            ...
            if (data) {
                ...
                setNewAssetData({
                    ...
                    responsible: '', processor: '', ram: '', storage: '', description: ''
                });
                setNewExpirations([]);
        ...
        return (
            <div className="bg-[#F8F9FA] min-h-screen pb-24 font-sans animate-in slide-in-from-right-5 duration-300">
                <div className="bg-white p-4 sticky top-0 z-20 shadow-sm flex items-center justify-between">
                    ...
                    <h1 className="font-bold text-lg text-slate-800 tracking-tight">Equipos de Informática</h1>
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                ...
                                <select
                                    ...
                                    aria-label="Propiedad del Activo"
                                >
                            ...
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    placeholder="EQ-001"
                                    className="w-full p-4 bg-slate-50 border-none rounded-2xl text-sm font-black text-slate-800 uppercase"
                        ...
                        {newAssetData.ownership === 'Propio' ? (
                            <div className="space-y-1.5">
                                ...
                                <input
                                    ...
                                    placeholder="0000"
                                    className="w-full p-4 bg-slate-50 border-none rounded-2xl text-sm font-mono font-bold text-orange-600 text-center tracking-widest"
                            ...
                            <div className="space-y-1.5 animate-in fade-in">
                                ...
                                <input
                                    ...
                                    className="w-full p-4 bg-blue-50 border-none rounded-2xl text-sm font-bold text-blue-800"
                                    aria-label="Proveedor"
                                />
                            </div>
                        )}

                        {/* Brand and Model with Auto-Name Generation */}
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-slate-400 uppercase ml-1">Procesador</label>
                                <input
                                    type="text"
                                    value={newAssetData.processor || ''}
                                    onChange={(e) => setNewAssetData({ ...newAssetData, processor: e.target.value })}
                                    className="w-full p-4 bg-slate-50 border-none rounded-2xl text-sm font-medium"
                                    placeholder="Ej. Intel i7"
                                />
                            </div>
                            <div className="space-y-1.5">
                                <label className="text-[10px] font-bold text-slate-400 uppercase ml-1">RAM</label>
                                <input
                                    type="text"
                                    value={newAssetData.ram || ''}
                                    onChange={(e) => setNewAssetData({ ...newAssetData, ram: e.target.value })}
                                    className="w-full p-4 bg-slate-50 border-none rounded-2xl text-sm font-medium"
                                    placeholder="Ej. 16GB"
                                />
                            </div>
                            <div className="col-span-2 space-y-1.5">
                                <label className="text-[10px] font-bold text-slate-400 uppercase ml-1">Almacenamiento</label>
                                <input
                                    type="text"
                                    value={newAssetData.storage || ''}
                                    onChange={(e) => setNewAssetData({ ...newAssetData, storage: e.target.value })}
                                    className="w-full p-4 bg-slate-50 border-none rounded-2xl text-sm font-medium"
                    ...
                    <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <input
                                ...
                                placeholder="Ej. Laptop Alta Gama"
                                className="w-full p-4 bg-slate-50 border-none rounded-2xl text-sm font-medium"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        aria-label="Valor Razonable (ARS)"
                                    />
                        ...
                        <div className="bg-slate-50 p-4 rounded-2xl border border-slate-100 space-y-3">
                            ...
                            <div className="flex gap-3">
                                <input
                                    ...
                                    aria-label="Notas del vencimiento"
                                />
                                <button
                            ...
                            <div className="space-y-2">
                                {newExpirations.map(exp => (
                                    <div key={exp.id} className="flex items-center justify-between p-3 bg-white border border-slate-100 rounded-xl">
                                        ...
                                        <button onClick={() => removeExpiration(exp.id)} className="text-slate-300 hover:text-red-500" aria-label="Eliminar vencimiento">
                                            <Trash2 size={16} />
                                        </button>
                                    </div>
                                ))}
                ...
                <div className="p-6 space-y-6">
                    ...
                    {isEditingAsset ? (
                        <div className="space-y-6">
                            ...
                            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 space-y-4">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <input
                                        ...
                                        className="w-full p-3 bg-slate-100 border-none rounded-xl text-sm font-bold text-slate-500"
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-bold text-slate-400 uppercase ml-1">Desc. Funcional</label>
                                    <textarea
                                        value={editFormData.functionalDescription}
                                        onChange={e => setEditFormData({ ...editFormData, functionalDescription: e.target.value })}
                                        className="w-full p-3 bg-slate-50 border-none rounded-xl text-sm font-medium resize-none"
                                        aria-label="Descripción Funcional"
                                    />
                                </div>

                                <div className="space-y-1.5">
                                    <label className="text-[10px] font-bold text-slate-400 uppercase ml-1">Desc. Complementaria</label>
                                    <textarea
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-bold text-slate-400 uppercase ml-1">Valor Razonable</label>
                                        <input
                                            type="number"
                            ...
                            {/* Expirations Edit */}
                            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 space-y-4">
                                <h3 className="text-xs font-bold text-slate-800 uppercase tracking-widest">Vencimientos y Seguros</h3>
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="grid grid-cols-3 gap-3 mt-6">
                                        <div className="bg-white/5 p-3 rounded-xl backdrop-blur-sm border border-white/5">
                                            ...
                                            <span className="text-sm font-bold">{selectedAsset.hours.toLocaleString()} <span className="text-[9px] font-normal text-white/50">{selectedAsset.type === 'Rodados' ? 'km' : 'hs'}</span></span>
                                        </div>
                                        <div className="bg-white/5 p-3 rounded-xl backdrop-blur-sm border border-white/5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 space-y-4 break-inside-avoid">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-bold text-slate-400 uppercase">Serie</p>
                                            <p className="text-sm font-bold text-slate-800 uppercase">{selectedAsset.serial}</p>
                                        </div>
                                    </div>
                                    <div className="grid grid-cols-2 gap-4 pt-2 border-t border-slate-50">
                                        <div>
                                            <p className="text-[10px] font-bold text-slate-400 uppercase">Procesador</p>
                                            <p className="text-xs font-bold text-slate-800 uppercase">{selectedAsset.processor || '-'}</p>
                                        </div>
                                        <div>
                                            <p className="text-[10px] font-bold text-slate-400 uppercase">RAM</p>
                                            <p className="text-xs font-bold text-slate-800 uppercase">{selectedAsset.ram || '-'}</p>
                                        </div>
                                        <div className="col-span-2">
                                            <p className="text-[10px] font-bold text-slate-400 uppercase">Almacenamiento</p>
                                            <p className="text-xs font-bold text-slate-800 uppercase">{selectedAsset.storage || '-'}</p>
                                        </div>
                                    </div>
    ...
    return (
        <div className="p-4 md:p-8 space-y-6 bg-[#F8F9FA] min-h-screen pb-24">
            ...
            <AssetImportModal
                ...
                initialAssetType="Equipos de Informática"
                forceAssetType={true}
            />
        </div>
    );
