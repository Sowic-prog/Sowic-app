...
import {
    ...
    HardHat, ScanLine, CalendarClock, Briefcase, Coins, Percent, FileType, AlertTriangle, CloudRain, Paperclip, FileCheck
} from 'lucide-react';
        ...
        return (
            <div className="bg-[#F8F9FA] min-h-screen pb-24 font-sans animate-in slide-in-from-right-5 duration-300">
                <div className="bg-white p-4 sticky top-0 z-20 shadow-sm flex items-center justify-between">
                    ...
                    <h1 className="font-bold text-lg text-slate-800">Nuevo Activo</h1>
                    ...
                    <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 space-y-4">
                        ...
                        <div className="space-y-1.5">
                            ...
                            <textarea
                                ...
                                placeholder="Función principal y características operativas..."
                ...
                <div className="p-6 space-y-6">
                    ...
                    {isEditingAsset ? (
                        <div className="space-y-6">
                            ...
                            {/* Technical Edit with Chassis/Engine */}
                            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 space-y-4">
                                <h3 className="text-xs font-bold text-slate-800 uppercase tracking-widest">Datos Técnicos</h3>
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-1.5">
    ...
    return (
        <div className="p-4 md:p-8 space-y-6 bg-[#F8F9FA] min-h-screen pb-24">
            ...
            <div className="flex justify-between items-center bg-white p-4 rounded-3xl shadow-sm sticky top-2 z-10 border border-slate-50">
                <h1 className="text-xl font-bold text-slate-800 pl-2">Activos</h1>
                <div className="flex gap-2">
                    <button
                        onClick={() => {
                            setNewAssetData({
